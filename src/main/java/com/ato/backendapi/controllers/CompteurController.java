...
public class CompteurController {
    ...
    public ResponseEntity<List<CompteurDTO>> getAllCompteurs(
        ...
        if (offset != null && pageSize != null) {
            Page<Compteur> pageCompteurs = compteurRepository.findAll(PageRequest.of(offset, pageSize));
            compteurs = pageCompteurs.getContent();
        } else {
        ...
        List<CompteurDTO> compteurDTOS = new ArrayList<>();
...
//    }
    ...
    public ResponseEntity<?> add(@RequestBody Compteur compteur,
