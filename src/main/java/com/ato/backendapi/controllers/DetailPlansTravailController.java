...
//    }
    ...
    @GetMapping("/detailPlansTravail/{id}")
    public ResponseEntity<DetailPlansTravailDTO> getDetailPlanJournalierById(@PathVariable(value = "id") Long id){
    DetailPlansTravail detailPlansTravail = detailPlansTravailRepository.findById(id)
    ...
    public ResponseEntity<?> add(@RequestBody DetailPlansTravail detailPlansTravail,
