...
import com.ato.backendapi.dto.ValidationDTO;
...
public class ValidationController {
    ...
    private ValidationDTO convertToValidationDTO(Validation validation) {
        ...
        if (demande != null) {
            ...
            Utilisateurs utilisateurSaisiDemande = demande.getUtilisateur_saisi_demande();
...
//    }
    ...
    public ResponseEntity<?> add(@RequestBody Validation validation,
