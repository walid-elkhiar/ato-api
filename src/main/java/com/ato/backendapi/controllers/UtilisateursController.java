...
//    }
    ...
    //POST
    @PostMapping("/users")
    public ResponseEntity<?> addUtilisateur(@RequestBody Utilisateurs utilisateurs,
                                 @RequestParam(required = false) Long idDepartement,
        ...
        System.out.println("Mot de passe généré : " + generatedPassword); // Ajoutez ce log ici
...
//    }
    ...
    //PUT
    @PutMapping("/users/{id}")
    public ResponseEntity<?> editUtilisateur(@PathVariable("id") Long id, @RequestBody Utilisateurs utilisateurs,
