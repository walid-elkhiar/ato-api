...
//    }
    ...
    public ResponseEntity<DetailPlansJournalier> add(@RequestBody DetailPlansJournalier detailPlansJournalier,
        ...
        try {
            ...
            if (detailPlansJournalier.getAffectationPlan() != null) {
                Long idAffectationPlan = detailPlansJournalier.getAffectationPlan().getIdAffectationPlan();
                AffectationPlan affectationPlan = affectationPlanRepository.findById(idAffectationPlan)
                        .orElseThrow(() -> new ResourceNotFoundException("AffectationPlan non trouvé avec l'ID : " + idAffectationPlan));
                detailPlansJournalier.setAffectationPlan(affectationPlan);
            } else {
                detailPlansJournalier.setAffectationPlan(null);
            }
    ...
    public ResponseEntity<DetailPlansJournalier> updateDetailPlansJournalier(@PathVariable("id") Long id,
                                                                             ...
                                                                             @RequestParam Long idPlanJournalier,
                                                                             @RequestParam Long idSousCodeTraitement,
                                                                             @RequestParam Long idAffectationPlan){
        DetailPlansJournalier detailPlansJournalier = detailPlansJournalierRepository.findById(id)
